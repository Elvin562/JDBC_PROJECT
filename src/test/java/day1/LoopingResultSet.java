...
public class LoopingResultSet {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        //next method will move yor cursor to next line
        //and also return true if you have more row and return false if there is no row
       // rs.next();
       // System.out.println("Region Value ar this row is: "+ rs.getString("REGION_NAME") );
       ...
       //rs.getString has overloaded version
        //and you can use column index instead of colimn names
